...
private:
    ...
    Vector3 m_IdleWeaponOffsetPos{ -4.6667f, 7.6667f, 0.0000f };
    Vector3 m_IdleWeaponOffsetRot{ 0.0000f, 0.0000f, -1.0000f };
    ...
    Vector3 m_AttackOffsetPos[3][3]{
        // Attack1
        { { -4.6667f, 7.6667f, 0.0000f }, { -4.6667f, 7.6667f, 0.0000f }, { -4.6667f, 7.6667f, 0.0000f } },
        // Attack2
        { { -4.6667f, 7.6667f, 0.0000f }, { -4.6667f, 7.6667f, 0.0000f }, { -4.6667f, 7.6667f, 0.0000f } },
        // Attack3
        { { -4.6667f, 7.6667f, 0.0000f }, { -4.6667f, 7.6667f, 0.0000f }, { -4.6667f, 7.6667f, 0.0000f } }
